...
const MedicationWarningModal = (props) => {
        ...
        <Grid>
            ...
            <Grid.Row>
                <Grid.Column textAlign={"center"} verticalAlign={"middle"}>
                    <h3 style={{color: "red"}}>The following medications are missing date information
            ...
            <Grid.Row style={{paddingTop: "0px"}}>
                <Grid.Column>
                    <Table
                        summaryId="medication-warning-table"
                        summary="This table contains details about undocumented medications."
